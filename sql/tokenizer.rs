        ...
        match c {
            ...
            '!' => {
                ...
                if chars.peek() == Some(&'=') {
                    ...
                    return Err(SQLError::TokenizerError("Unexpected '!' without '='".into()));
                }
            }
            ...
            c if c.is_alphabetic() => {
                ...
                match word_upper.as_str() {
                    ...
                    "CREATE" => tokens.push(Token::Keyword(Keyword::Create)),
                    "TABLE" => tokens.push(Token::Keyword(Keyword::Table)),
                    "PRIMARY" => tokens.push(Token::Keyword(Keyword::Primary)),
                    "KEY" => tokens.push(Token::Keyword(Keyword::Key)),
                    "CHECK" => tokens.push(Token::Keyword(Keyword::Check)),
                    "INT" => tokens.push(Token::Keyword(Keyword::Int)),
                    "BOOL" => tokens.push(Token::Keyword(Keyword::Bool)),
                    "VARCHAR" => tokens.push(Token::Keyword(Keyword::Varchar)),
                    "NULL" => tokens.push(Token::Keyword(Keyword::Null)),
